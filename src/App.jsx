/**
 * VA Studio Frontend — Onboarding Standalone
 *
 * This is a standalone version of the Onboarding template.
 * It renders the Onboarding template directly as the main interface.
 *
 * Routes:
...
import TemplateApp from '../templates/onboarding/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (Onboarding Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
